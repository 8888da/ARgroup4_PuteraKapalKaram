...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '../../assets/audio/bm/pg1.wav');
    const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '../../assets/audio/bm/pg2.wav');
    const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '../../assets/audio/bm/pg3.wav');
    const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '../../assets/audio/bm/pg4.wav');
    const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '../../assets/audio/bm/pg5.wav');
    const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '../../assets/audio/bm/pg6.wav');
    const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '../../assets/audio/bm/pg7.wav');
    const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '../../assets/audio/bm/pg8.wav');
    const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '../../assets/audio/bm/pg9.wav');
    const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '../../assets/audio/bm/pg10.wav');
    const page11Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page11Model, 10,  '../../assets/audio/bm/pg11.wav');
    const page12Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page12Model, 11,  '../../assets/audio/bm/pg12.wav');
    const page13Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page13Model, 12,  '../../assets/audio/bm/pg13.wav');
    const page14Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page14Model, 13,  '../../assets/audio/bm/pg14.wav');
    const page15Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page15Model, 14,  '../../assets/audio/bm/pg15.wav');
